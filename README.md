...
| `GET /v1/themes` | every valid theme name and its puzzle count |
...
30 requests a minute per IP. A key raises that — open an issue saying what you
are building. Responses carry `X-RateLimit-Remaining`; a `429` carries
